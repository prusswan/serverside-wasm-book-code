...
#[doc(hidden)]
macro_rules! __export_world_lib_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_lib_cabi;
#[repr(align(4))]
...
macro_rules! __export_lib_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_lib_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:composability:lib:lib:encoded world"]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x04\0\x15composability:lib/lib\x04\0\x0b\x09\x01\
\0\x03lib\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.\
