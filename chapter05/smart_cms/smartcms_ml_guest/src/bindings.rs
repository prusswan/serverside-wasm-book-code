...
pub unsafe fn _export_storygen_cabi<T: Guest>() -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let result0 = T::storygen();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_storygen<T: Guest>(arg0: *mut u8) {
    let l0 = *arg0.add(0).cast::<*mut u8>();
    let l1 = *arg0.add(4).cast::<usize>();
    _rt::cabi_dealloc(l0, l1, 1);
}
pub trait Guest {
    fn storygen() -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_example_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[export_name = "storygen"] unsafe extern "C" fn
        export_storygen() -> * mut u8 { $($path_to_types)*:: _export_storygen_cabi::<$ty
        > () } #[export_name = "cabi_post_storygen"] unsafe extern "C" fn
        _post_return_storygen(arg0 : * mut u8,) { $($path_to_types)*::
        __post_return_storygen::<$ty > (arg0) } };
    };
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:component:smartcms-ml-guest:example:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1578] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xac\x0b\x01A\x02\x01\
A\x0e\x01B\x11\x01py\x04\0\x11tensor-dimensions\x03\0\0\x01m\x07\x04FP16\x04FP32\
...
ethod]tensor.data\x01\x0c\x03\0\"wasi:nn/tensor@0.2.0-rc-2024-08-19\x05\0\x01B\x08\
...
data\x01\x05\x03\0\"wasi:nn/errors@0.2.0-rc-2024-08-19\x05\x01\x02\x03\0\x01\x05\
error\x02\x03\0\0\x06tensor\x02\x03\0\0\x0btensor-data\x01B\x12\x02\x03\x02\x01\x02\
\x04\0\x05error\x03\0\0\x02\x03\x02\x01\x03\x04\0\x06tensor\x03\0\x02\x02\x03\x02\
\x01\x04\x04\0\x0btensor-data\x03\0\x04\x04\0\x17graph-execution-context\x03\x01\
\x01h\x06\x01i\x03\x01i\x01\x01j\0\x01\x09\x01@\x03\x04self\x07\x04names\x06tens\
or\x08\0\x0a\x04\0)[method]graph-execution-context.set-input\x01\x0b\x01@\x01\x04\
self\x07\0\x0a\x04\0'[method]graph-execution-context.compute\x01\x0c\x01j\x01\x08\
\x01\x09\x01@\x02\x04self\x07\x04names\0\x0d\x04\0*[method]graph-execution-conte\
xt.get-output\x01\x0e\x03\0%wasi:nn/inference@0.2.0-rc-2024-08-19\x05\x05\x02\x03\
\0\x02\x17graph-execution-context\x01B\x1a\x02\x03\x02\x01\x02\x04\0\x05error\x03\
\0\0\x02\x03\x02\x01\x03\x04\0\x06tensor\x03\0\x02\x02\x03\x02\x01\x06\x04\0\x17\
graph-execution-context\x03\0\x04\x04\0\x05graph\x03\x01\x01m\x07\x08openvino\x04\
onnx\x0atensorflow\x07pytorch\x0etensorflowlite\x04ggml\x0aautodetect\x04\0\x0eg\
raph-encoding\x03\0\x07\x01m\x03\x03cpu\x03gpu\x03tpu\x04\0\x10execution-target\x03\
\0\x09\x01p}\x04\0\x0dgraph-builder\x03\0\x0b\x01h\x06\x01i\x05\x01i\x01\x01j\x01\
\x0e\x01\x0f\x01@\x01\x04self\x0d\0\x10\x04\0$[method]graph.init-execution-conte\
xt\x01\x11\x01p\x0c\x01i\x06\x01j\x01\x13\x01\x0f\x01@\x03\x07builder\x12\x08enc\
oding\x08\x06target\x0a\0\x14\x04\0\x04load\x01\x15\x01@\x01\x04names\0\x14\x04\0\
\x0cload-by-name\x01\x16\x03\0!wasi:nn/graph@0.2.0-rc-2024-08-19\x05\x07\x01@\0\0\
s\x04\0\x08storygen\x01\x08\x04\0#component:smartcms-ml-guest/example\x04\0\x0b\x0d\
